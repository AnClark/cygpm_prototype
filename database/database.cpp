...
int CygpmDatabase::parseAndBuildDatabase(const char *setupini_fileName)
{
    ...
    int num_packages = 0; // Packages' count
    ...
    while (token_type = yylex())
    {
        ...
        {
        case T_Package_Name:
            num_packages++; // Stat package count
...
int CygpmDatabase::insertPackageInfo(CurrentPackageInfo *packageInfo)
{
    // Pre-define SQL query
    const char *SQL_INSERT_PACKAGE_INFO = R"(
        INSERT INTO "PKG_INFO" (PKG_NAME, SDESC, LDESC, CATEGORY, REQUIRES__RAW, VERSION, _INSTALL__RAW, INSTALL_PAK_PATH, INSTALL_PAK_SIZE, INSTALL_PAK_SHA512, _SOURCE__RAW, SOURCE_PAK_PATH, SOURCE_PAK_SIZE, SOURCE_PAK_SHA512, DEPENDS2__RAW)
    ...
    cout << "====================================================" << endl;
    cout << "Package - " << packageInfo->pkg_name << endl;
    cout << "sdesc: " << packageInfo->sdesc << endl;
    cout << "ldesc: " << packageInfo->ldesc << endl;
    cout << "category: " << packageInfo->category << endl;
    cout << "requires: " << packageInfo->requires__raw << endl;
    cout << "version: " << packageInfo->version << endl;
    cout << "install: " << packageInfo->install__raw << endl;
    cout << "source: " << packageInfo->source__raw << endl;
    cout << "depends2: " << packageInfo->depends2__raw << endl;
}
